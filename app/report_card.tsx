    ...
    return (
      <View style={globalStyles.card}>
        ...
        <Text
          style={[
            globalStyles.status,
            status === "Muito Bom" ? globalStyles.mb : status === "Aprovado" ? globalStyles.mb : globalStyles,
            status === "Bom" ? globalStyles.b : status === "Aprovado" ? globalStyles.mb : globalStyles,
            status === "Ruim" ? globalStyles.r : status === "Aprovado" ? globalStyles.mb : globalStyles,
          ]}
        >
          {status}
        </Text>
